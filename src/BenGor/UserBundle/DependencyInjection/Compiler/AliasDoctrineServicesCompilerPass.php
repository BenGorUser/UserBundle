 ...
 *
 * In most cases, this bundle is going to be used in
...
class AliasDoctrineServicesCompilerPass implements CompilerPassInterface
{
    ...
    public function process(ContainerBuilder $container)
    {
        ...
        $aliasMap = [
            'bengor_user.in_memory_user_repository' => 'bengor.user.infrastructure.persistence.in_memory.user_repository',
            'bengor_user.in_memory_user_guest_repository' =>  'bengor.user.infrastructure.persistence.in_memory.user_guest_repository'
        ];
