...
class AliasServicesCompilerPass implements CompilerPassInterface
{
    ...
    public function process(ContainerBuilder $container)
    {
        ...
        foreach ($config['user_class'] as $key => $user) {
            ...
            $container->setAlias(
                'bengor_user.doctrine_' . $key . '_repository',
                'bengor.user.infrastructure.persistence.doctrine.' . $key . '_repository'
            );
            if (null !== $guestClass) {
                $container->setAlias(
                    'bengor_user.doctrine_' . $key . '_guest_repository',
