...
class SecurityServicesPassSpec extends ObjectBehavior
{
    ...
    function it_processes(ContainerBuilder $container, Definition $definition)
    {
        ...
        $container->setDefinition('user_password_encoder', Argument::type(Definition::class))
            ->shouldBeCalled()->willReturn($definition);

        $container->getDefinition('user_password_encoder')->shouldBeCalled()->willReturn($definition);
        $definition->setPublic(false)->shouldBeCalled()->willReturn($definition);
        $container->setDefinition(
            'bengor.user.infrastructure.security.symfony.user_password_encoder', Argument::type(Definition::class)
        )->shouldBeCalled()->willReturn($definition);
